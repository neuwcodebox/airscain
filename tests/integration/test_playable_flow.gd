...
func test_training_mode_guides_real_deployment_flow_and_disables_saves() -> void:
	...
	assert_true(training.training_approach_marker.visible)
	assert_string_contains(training.training_approach_marker.text, "진입 방향")
	...
	assert_gt(threat.global_position.x, training.objective.global_position.x + 500.0)
	...
	assert_false(training.training_approach_marker.visible)
