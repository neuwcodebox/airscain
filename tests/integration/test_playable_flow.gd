...
func test_raid_budget_grows_gradually_regardless_of_airborne_count() -> void:
	...
	assert_almost_eq(main.director.threat_budget_at(135.0), 4.5, 0.001)
	assert_almost_eq(main.director.threat_budget_at(405.0), 6.75, 0.001)
	assert_almost_eq(main.director.threat_budget_at(765.0), 9.75, 0.001)
