...
All media is under build/trailer_v4, never in the game's distributable resources.
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('shots', nargs='+', choices=['intro', 'expansion', 'raid', 'crisis'])
