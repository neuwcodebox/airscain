...
var initial_shadow_alpha: float = 1.0
...
func _create_shadow_particles() -> void:
	...
	shadow_material.set_shader_parameter("base_alpha", standard_material.albedo_color.a)
	...
	if standard_material.albedo_texture != null:
		shadow_material.set_shader_parameter("use_albedo_texture", true)
		shadow_material.set_shader_parameter("albedo_texture", standard_material.albedo_texture)
	shadow_mesh.surface_set_material(0, shadow_material)
	initial_shadow_alpha = standard_material.albedo_color.a
