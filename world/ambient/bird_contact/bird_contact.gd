...
func restore_content_state(state: Dictionary, _objective: ProtectedObjective, battlefield_value: Battlefield, _defense_by_id: Dictionary[int, DefenseUnit] = {}) -> void:
	battlefield = battlefield_value
	patrol_bounds = battlefield.battlefield_size * 0.4
