...
사용자가 제공한 `jet_flyover_1.ogg`, `jet_flyover_2.ogg`, `jet_flyover_3.ogg` 원본을 그대로 포함한다. 원본 제공 위치는 Windows 바탕화면이며 이 파일명에 대응하는 원 출처 URL과 라이선스 자료는 제공되지 않았다.
...
| jet_flyover_3.ogg | 21.050초 | −6.1 | +1.1dBFS | −19.9dB | −26.0 / −18.8dBFS |
